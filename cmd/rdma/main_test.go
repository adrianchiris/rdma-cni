...
import (
	...
	cacheMocks "github.com/adrianchiris/rdma-cni/pkg/cache/mocks"
	"github.com/adrianchiris/rdma-cni/pkg/rdma"
	rdmaMocks "github.com/adrianchiris/rdma-cni/pkg/rdma/mocks"
	...
	Describe("Test ensureRdmaSystemMode()", func() {
		...
		Context("Good flow", func() {
			It("Should succeed if rdma system namespace mode is exclusive", func() {
				rdmaMgrMock.On("GetSystemRdmaMode").Return(rdma.RdmaSysModeExlusive, nil)
